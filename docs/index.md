...
---
## Notes
- The CLI tool uses hyphens in its name (`flyfield`), while the repository uses underscores (`flyfield`). This is expected.
...
---
Start your journey by exploring the [Quick Start Guide](quick_start.md) or jump directly to the [Worked Example](example.md).
